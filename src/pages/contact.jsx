...
export default function Contact() {
  ...
  const WEB3FORMS_ACCESS_KEY = "4fa7b1a8-0ea4-43a3-b823-4007f8411b30";
    ...
    try {
      const response = await fetch("https://api.web3forms.com/submit", {
        ...
        body: JSON.stringify({
          ...
          subject: `Nova mensagem de ${formData.name} - Site Inova Byte`,
          from_name: "Site Inova Byte",
          to: "inovabyte.sistemas@gmail.com",
        }),
      });
      ...
      setError("Erro ao enviar mensagem. Tente novamente ou entre em contato diretamente pelo email.");
    }
  ...
  const contactInfo = [
    {
      ...
      link: "mailto:inovabyte.sistemas@gmail.com",
    },
    {
      icon: MapPin,
      title: "Localização",
      value: "BR-408 - Sapucaia, Timbaúba - PE, CEP: 55871-665",
    },
    {
      icon: Phone,
      title: "Telefone",
      value: "(81) 9 3631-5266",
      link: "tel:+5581936315266",
    },
  ];
